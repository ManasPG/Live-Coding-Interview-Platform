...
function StatsCards({ activeSessionsCount, recentSessionsCount }) {
  return (
    <div className="lg:col-span-1 grid grid-cols-1 gap-6">
      {/* Active Count */}
      <div className="card bg-base-100/90 surface-card hover:border-primary/35 transition-colors">
      ...
      {/* Recent Count */}
      <div className="card bg-base-100/90 surface-card hover:border-secondary/35 transition-colors">
        <div className="card-body">
          <div className="flex items-center justify-between mb-3">
