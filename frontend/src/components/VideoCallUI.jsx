...
function VideoCallUI({ chatClient, channel, isHost, sessionId }) {
              ...
              try {
                if (isHost && sessionId) {
                  ...
                  if (channel && chatClient) {
                    const userId =
                      chatClient.userID ||
                      (chatClient.user && chatClient.user.id);
                    if (userId) {
                      try {
                    ...
                    try {
                      ...
                      console.warn(
                        "Failed to disconnect chat client:",
                        err.message || err,
                      );
                    }
                ...
                console.error("Error on leave handler", error);
              } finally {
                navigate("/dashboard");
              }
            }}
